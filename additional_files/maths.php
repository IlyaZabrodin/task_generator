  ...
  <body>
    ...
    <div>
      <?php
        ...
        mysqli_close($str);
      ?>
      <button class="w-10 btn btn-lg btn-primary" type="submit" onclick="window.location.href='show_tasks2.php';">Проверить</button>
      <button class="w-10 btn btn-lg btn-primary" type="submit" onclick="window.location.href='maths_answers.php';">Хочу посмотреть разбор заданий</button>
