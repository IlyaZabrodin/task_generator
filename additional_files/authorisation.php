<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if(mysqli_num_rows($query) > 0) {
          ...
          echo "<br>Введён неправильный логин или пароль.";
        }
    }
?>
...
<html lang="en">
  <head>
    ...
    <link href="../project/signin.css" rel="stylesheet">
  </head>
  <body>
      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li>
              <a class="nav-link px-2 text-white">Вход</a>          
            </li>
          </ul>
    ...
    <main class="form-signin">
      <form method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" name="log" id="floatingInput" placeholder="name@example.com">
        ...
        <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit" >Войти</button>
      </form>
    </main>
